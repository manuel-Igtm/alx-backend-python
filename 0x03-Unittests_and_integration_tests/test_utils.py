...
class TestAccessNestedMap(unittest.TestCase):
    ...
    @parameterized.expand([
        ("simple_path", {"a": 1}, ("a",), 1),
        ("nested_path_one", {"a": {"b": 2}}, ("a",), {"b": 2}),
        ("nested_path_two", {"a": {"b": 2}}, ("a", "b"), 2),
    ])
    ...
    @parameterized.expand([
        ("missing_key", {}, ("a",), 'a'),
        ("nested_missing_key", {"a": 1}, ("a", "b"), 'b'),
    ])
    def test_access_nested_map_exception(self, _, nested_map, path, missing_key):
